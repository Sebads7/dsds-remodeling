...
const ContactPage = () => {
  ...
  return (
    <div className="h-full pt-10 bg-light-bg px-5">
      <h1 className=" font-extrabold text-3xl md:text-5xl  z-10 text-center text-neutral-800 mb-20  ">
        CONTACT
      </h1>
      <div>
        <motion.div
          className="flex flex-col lg:flex-row lg:gap-20 items-center w-full max-w-6xl mx-auto lg:pl-10"
          variants={LeftLoading}
          initial="initial"
          animate="animate"
        >
          <div className="lg:z-10   text-main-dark ">
            <h2 className="text-xl max-w-md md:text-5xl font-semibold   pl-5 pb-3 text-center lg:text-start ">
